		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comdemoromanconverter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoromanconverter-display": {
								"semanticObject": "comdemoromanconverter",
								"action": "display",
								"description": "Roman Converter",
								"title": "Roman Converter",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.romanconverter",
									"url": sap.ui.require.toUrl("com/demo/romanconverter")
								}
							}
						}
					}
